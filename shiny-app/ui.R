              ...
              mainPanel(
                tabsetPanel(
                      ...
                      column(10, 
                          sidebarLayout(
                               sidebarPanel(radioButtons("indg_analysis", "Show:",
                                                         c("Total of Indigenous Population" = "0", 
                                                           "Indigenous Percentage of the State Population (%)" = "1"),
                                                         inline = F, 
                                                         selected = "0"),
                                            radioButtons("indg_myYear", 
                                                         "Year:",
                                                         c("2010" = "2010", 
                                                           "2000" = "2000", 
                                                           "1991" = "1991"), 
                  ...
                  tabPanel("Urban-Rural Population",
                       column(10, 
                              sidebarLayout(
                                sidebarPanel(radioButtons("pop_analysis", 
                                                          "Show:",
                                                          c("Urban Population" = "0", 
                                                            "Rural Population" = "1",
                                                            "Total Population" = "2"),
                                                          inline = F),
                                             radioButtons("pop_myYear",
                                                          "Year:",
                                                          c("2010" = "2010", 
                                                            "2000" = "2000",
                                                            "1991" = "1991",
